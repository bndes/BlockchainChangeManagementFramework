var Governance = artifacts.require("./changeManagementFramework/governance/Governance.sol");
var UpgraderInfo = artifacts.require("./changeManagementFramework/core/UpgraderInfo.sol");
var Resolver = artifacts.require("./changeManagementFramework/core/Resolver.sol");

var PreUpgrader1 = artifacts.require("./example/upgraders/PreUpgrader.sol");
var Upgrader1 = artifacts.require("./example/upgraders/upgrader1.sol");
var Upgrader2 = artifacts.require("./example/upgraders/Upgrader2.sol");

var BNDESRegistry = artifacts.require("./example/BNDESRegistry.sol");
...
contract('GovernanceInAction', async accounts => {
  ...
  it("should create the PreUpgrader contract with Governance - async", async () => {
    ...
    preUpgrader1 = await PreUpgrader.new(bndesAddr,bndesAddr,governanceMembersId, bndesAddr);    
  ...
  it("if account does not exist, the ID is 0 -- async", async () => {

    let cnpjById = await bndesRegistry.getId(id2);

    assert.equal(cnpjById, 0, "ID was not saved or recovered in a correct form " + cnpjById);    
  ...
  it("should execute the change upgrader1 -- async", async () => {
    ...
    let resultGetChange  = await governanceInstance.getChange(2);
    let cnpj = await bndesRegistry.getId(bndesAddr);
